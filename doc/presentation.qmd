...
=======
::: {.column width="50%"}
>>>>>>> dab444ef7668bb5a92aba36457c89727ed736218
-   MedQb: three clusters
    -   Thymocytes cluster with T-cells from blood
    -   B-cells form a tonsil cluster and a blood cluster
-   PEpos
    -   We get 4 distinct clusters
    -   B-cells seperates in PC2, but very similar in PC1
:::
...
![](images/compare_Bnaive.png)
:::

::: {.column width="50%"}
![](images/08_key_plot.png)
:::
:::::
