...
The data consists of immunological measurements from blood, tonsil and thymus. The dataset consists of observations and 9 variables containing CD markers for the cell types in the specific tissue. An overview of the quantitative markers is given below using a table1 summary of data_clean. **The data is structured in long format,** meaning that each combination of tissue, cell type and CD marker appears as one row. This structure makes the dataset suitable for visualization and statistical analysis
